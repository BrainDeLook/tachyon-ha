...
Кнопка «Открыть веб-интерфейс» и пункт Tachyon в боковой панели используют Home Assistant Ingress. При открытии в Home Assistant Tachyon запрашивает полноэкранный режим; плавающая кнопка «Home Assistant» в правом нижнем углу открывает боковую панель HA. Вне Ingress полноэкранный режим не включается. Аддон получает динамический префикс Ingress и разрешает встраивание интерфейса только в страницу того же сайта.
